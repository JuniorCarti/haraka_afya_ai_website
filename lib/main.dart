...
Future<void> _openUrl(Uri url) async {
 ...
 // Stories Section
  ...
  Widget _buildStoryCard(String title, String excerpt, String imageUrl) {
    final colorScheme = Theme.of(context).colorScheme;
    return SizedBox(
      width: 360,
      child: Card(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: FilledButton(
                      onPressed: () => _showStoryModal(title, excerpt, imageUrl),
                      style: FilledButton.styleFrom(
  ...
  Widget _buildProgramCard(IconData icon, String title, String description, Color color) {
    return SizedBox(
      width: 280,
      child: Card(
        elevation: 6,
  ...
  void _showStoryModal(String title, String excerpt, String imageUrl) {
    showDialog(
      context: context,
      builder: (context) {
        return Dialog(
